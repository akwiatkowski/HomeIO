...
# Second version of Onet.pl
# It worked only for some days
# Daily prediction, doesn't work because there were added details and
# this makes times array larget than temperatures array

class WeatherOnetPlB < WeatherBase
